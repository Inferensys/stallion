...
- [x] **SAND-06**: Credential proxy — CC session never sees raw API keys; proxy injects auth headers
...
*Last updated: 2026-03-07 after roadmap creation — AUTH and CONF consolidated into Phase 3 (coarse granularity)*
